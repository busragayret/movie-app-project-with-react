...
function FilterMovie() {
    ...
    useEffect(() => {
        setTimeout(() => {
            const url = `https://api.themoviedb.org/3/movie/${params.category}?api_key=1049fd941cd2e947ed04ba7c0abf256b`
                ...
                <div className="container-fluid my-5">
                    <div className="row">
                        ...
                        <div className="col-md-8 text-center">
                            ...
                            <button className='loadBtn btn btn-dark' onClick={showData}>Load More</button>
                        </div>
                    </div>
                </div>
            </div>
